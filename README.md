...
Lab 10: To implement an Artificial Neural Network (ANN) to classify patients as having Chronic Kidney Disease (CKD) or not.

Lab 11: To implement a Convolutional Neural Network (CNN) for handwritten digit classification using the MNIST dataset.

Lab 12: Understand the fundamentals of Generative AI and experiment with prompt-based tools. NLP Basics Understand basic NLP concepts and apply text preprocessing techniques. using Python Text Vectorization and Similarity Analysis Apply text vectorization techniques (TF-IDF, embeddings) for similarity and analysis tasks.
